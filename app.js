...
(function () {
  ...
  const essays = [
    ...
    },
    {
      ...
      truth: { ar: 'نلوم الشيطان على كل سقطة، لكن الشيطان لا يملك سلطانًا على نفس قوية. الضعف النفسي هو الباب الذي يدخل منه.', en: 'We blame Satan for every fall, but Satan has no power over a strong soul. Psychological weakness is the door through which he enters.', fr: 'Nous accusons Satan de chaque chute, mais Satan n\'a aucun pouvoir sur une ame forte. La faiblesse psychologique est la porte par laquelle il entre.' },
      bitter: { ar: 'لأن الاعتراف بضعفنا النفسي أصعب من إلقاء اللوم على قوة خارجية.', en: 'Because admitting our psychological weakness is harder than blaming an external force.', fr: 'Parce qu\'admettre notre faiblesse psychologique est plus difficile que de blamer une force externe.' },
      cure: { ar: 'قوِّ نفسك بالعلم والعبادة الواعية. اجعل عقلك حصنًا قبل أن تبحث عن أعذار.', en: 'Strengthen yourself with knowledge and mindful worship. Make your mind a fortress before seeking excuses.', fr: 'Renforcez-vous par le savoir et l\'adoration consciente. Faites de votre esprit une forteresse.' }
    },
    {
      id: 4, cat: 'self', emoji: '🔍',
      ...
      truth: { ar: 'نقضي أوقاتنا في تحليل مؤامرات الآخرين، ونتجاهل أن أكبر مؤامرة هي جهلنا بأنفسنا وتقصيرنا في واجباتنا.', en: 'We spend our time analyzing others\' conspiracies while ignoring that the biggest conspiracy is our own ignorance and negligence.', fr: 'Nous passons notre temps a analyser les complots des autres, ignorant que le plus grand complot est notre propre ignorance.' },
      bitter: { ar: 'لأن لوم الآخرين يريحنا من مسؤولية التغيير.', en: 'Because blaming others relieves us of the responsibility to change.', fr: 'Parce que blamer les autres nous libere de la responsabilite de changer.' },
      cure: { ar: 'خصص وقتًا لنقد ذاتك كما تخصصه لانتقاد غيرك. المرآة أصدق من النافذة.', en: 'Spend time critiquing yourself as you critique others. The mirror is more honest than the window.', fr: 'Consacrez du temps a vous critiquer comme vous critiquez les autres. Le miroir est plus honnete que la fenetre.' }
    },
    {
      ...
      truth: { ar: 'عندما يكون صاحب البيت جبانًا، يصبح اللص جريئًا. ضعفنا هو ما يجرّئ عدونا علينا، لا قوته.', en: 'When the homeowner is cowardly, the thief becomes bold. Our weakness emboldens the enemy, not their strength.', fr: 'Quand le proprietaire est lache, le voleur devient audacieux. Notre faiblesse encourage l\'ennemi, pas sa force.' },
      bitter: { ar: 'لأننا نفضّل الشكوى على بناء القوة. الضعيف يستسهل البكاء.', en: 'Because we prefer complaining to building strength. The weak find it easier to cry.', fr: 'Parce que nous preferons nous plaindre plutot que de construire notre force.' },
      cure: { ar: 'كن قويًا في بيتك — في علمك، أخلاقك، إنتاجك. اللص لا يقترب من بيتٍ صاحبه يقظ.', en: 'Be strong in your house — in your knowledge, ethics, and productivity. A thief doesn\'t approach a home whose owner is alert.', fr: 'Soyez fort dans votre maison — en savoir, en ethique, en productivite. Le voleur n\'approche pas une maison dont le proprietaire est vigilant.' }
    },
    {
      id: 6, cat: 'self', emoji: '📖',
      title: { ar: 'جهل الحق سبب ضياعه', en: 'Ignorance of Truth Is Why It Is Lost', fr: 'L\'ignorance de la verite est la cause de sa perte' },
      truth: { ar: 'لا نضيع الحق لأن أعداءنا أقوياء، بل لأننا لا نعرف حقنا أصلًا. الجاهل بحقه لا يستطيع المطالبة به.', en: 'We don\'t lose our rights because enemies are strong, but because we don\'t even know our rights. Those ignorant of their rights cannot demand them.', fr: 'Nous ne perdons pas nos droits parce que les ennemis sont forts, mais parce que nous ne connaissons meme pas nos droits.' },
      bitter: { ar: 'لأن التعلّم يحتاج وقتًا وجهدًا، والكسل أسهل.', en: 'Because learning takes time and effort, and laziness is easier.', fr: 'Parce que l\'apprentissage demande du temps et de l\'effort, et la paresse est plus facile.' },
      cure: { ar: 'تعلّم دينك وتاريخك وحقوقك. المعرفة سلاح لا يُهزم حامله.', en: 'Learn your religion, history, and rights. Knowledge is a weapon whose bearer cannot be defeated.', fr: 'Apprenez votre religion, votre histoire et vos droits. Le savoir est une arme invincible.' }
    },
    {
      id: 7, cat: 'self', emoji: '⏳',
      ...
      truth: { ar: 'التخلف العلمي والحضاري ليس قدرًا محتومًا بل هو ذنب عظيم. أمة تملك كل المقومات وتبقى متخلفة ارتكبت خطيئة بحق نفسها.', en: 'Scientific and civilizational backwardness is not fate — it is a great sin. A nation with all resources that remains backward has sinned against itself.', fr: 'Le retard scientifique et civilisationnel n\'est pas une fatalite — c\'est un grand peche. Une nation qui a toutes les ressources et reste en retard a peche contre elle-meme.' },
      bitter: { ar: 'لأننا اعتدنا اعتبار التخلف قدرًا وليس مسؤولية.', en: 'Because we\'ve gotten used to treating backwardness as fate, not responsibility.', fr: 'Parce que nous nous sommes habitues a considerer le retard comme une fatalite, pas une responsabilite.' },
      cure: { ar: 'اعتبر طلب العلم عبادة والإنتاج جهادًا. لا عذر لأمة عندها القرآن وتبقى في الظلام.', en: 'Consider seeking knowledge as worship and productivity as jihad. No excuse for a nation with the Quran to remain in darkness.', fr: 'Considerez la quete du savoir comme une adoration et la productivite comme un jihad.' }
    },
    {
      ...
      truth: { ar: 'نستورد المباني والأنظمة من الغرب لكن بلا الأسس التي قامت عليها: حرية الفكر، المساءلة، سيادة القانون. ننسخ القشرة ونترك اللب.', en: 'We import buildings and systems from the West but without their foundations: freedom of thought, accountability, rule of law. We copy the shell and leave the core.', fr: 'Nous importons les batiments et les systemes de l\'Occident sans leurs fondations : liberte de pensee, responsabilite, etat de droit. Nous copions la coquille et laissons le noyau.' },
      bitter: { ar: 'لأن بناء الأسس أصعب وأبطأ من نسخ الواجهات.', en: 'Because building foundations is harder and slower than copying facades.', fr: 'Parce que construire les fondations est plus difficile et plus lent que copier les facades.' },
      cure: { ar: 'ابنِ الإنسان قبل البنيان. أصلح التعليم والأخلاق، ثم سيأتي التقدم طبيعيًا.', en: 'Build the person before the building. Fix education and ethics, then progress will come naturally.', fr: 'Construisez l\'humain avant le batiment. Reformez l\'education et l\'ethique, et le progres viendra naturellement.' }
    },
